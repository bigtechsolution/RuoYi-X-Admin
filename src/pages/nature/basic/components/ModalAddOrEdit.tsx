...
import {ProFormDigit, ProFormInstance, ProFormSelect} from '@ant-design/pro-components';
  ...
  return (
    ...
    >
      <ProForm<any> submitter={false} formRef={formRef}>
        ...
        />
        <ProFormDigit name="cost" label="치료비" rules={[{ required: true }]} />
        <ProFormDigit name="exclusiveTherapistCost" label="고정치료비" rules={[{ required: true }]} />
